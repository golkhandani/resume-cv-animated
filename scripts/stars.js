...
let stars = [
    ...Array.from({ length: isMobile ? 20 : 80 }, () => [
        Math.random() * width,
        Math.random() * height,
        Math.random() * 2 + 1,
    ...
    ...Array.from({ length: isMobile ? 8 : 20 }, () => {
...
const pointerTargets = isMobile ? [] : [
    ...document.querySelectorAll('.btn-download, .links a, .skills span')
];
